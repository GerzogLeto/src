...
public class GetDocumentFromURL {
    public  Elements getElements(Element el, String str){
        return el.getElementsByClass(str);
    }
    public  String processElements (Elements el, String str){
        switch (str) {
            case "blue-link":
    ...
    public  void writeData(String data, CompanyData cd, String className){
        switch (className) {
            case "blue-link":
    ...
    public  void writeData(String[] data, CompanyData cd){
        cd.setNumberPhones(data);
    }
    public  String[] getTelephones (Elements el){
    ...
    public  String getUrlLinks (Element el) throws IOException, Exception {
    ...
    public  String getString (CompanyData companyData){
        String telNumbers = "";
    ...
    public  void writeStringToFile(CompanyData[] arr) throws Exception{
    ...
    public  void getDataAndWrite(String str) throws IOException, Exception {
